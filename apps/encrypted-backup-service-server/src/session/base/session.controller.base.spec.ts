...
const CREATE_INPUT = {
  ...
  sessionUser: "exampleSessionUser",
  token: "exampleToken",
  updatedAt: new Date(),
};
const CREATE_RESULT = {
  ...
  test("POST /sessions", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        sessionCreatedAt: CREATE_RESULT.sessionCreatedAt.toISOString(),
        sessionExpiresAt: CREATE_RESULT.sessionExpiresAt.toISOString(),
      ...
      .expect([
        {
          ...
          sessionCreatedAt: FIND_MANY_RESULT[0].sessionCreatedAt.toISOString(),
          sessionExpiresAt: FIND_MANY_RESULT[0].sessionExpiresAt.toISOString(),
  ...
  test("GET /sessions/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        sessionCreatedAt: FIND_ONE_RESULT.sessionCreatedAt.toISOString(),
        sessionExpiresAt: FIND_ONE_RESULT.sessionExpiresAt.toISOString(),
