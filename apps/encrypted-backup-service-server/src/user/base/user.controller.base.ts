...
import { BackupFindManyArgs } from "../../backup/base/BackupFindManyArgs";
...
export class UserControllerBase {
  ...
  @common.Get("/:id/backups")
  @ApiNestedQuery(BackupFindManyArgs)
  async findBackups(
    @common.Req() request: Request,
    @common.Param() params: UserWhereUniqueInput
  ): Promise<Backup[]> {
    const query = plainToClass(BackupFindManyArgs, request.query);
    const results = await this.service.findBackups(params.id, {
      ...query,
      select: {
        backupData: true,
        backupUser: true,
  ...
  @common.Post("/:id/backups")
  async connectBackups(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: BackupWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      backups: {
        connect: body,
  ...
  @common.Delete("/:id/backups")
  async disconnectBackups(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: BackupWhereUniqueInput[]
  ): Promise<void> {
    const data = {
